...
* `overview()` qui renvoie à l'image de la fonction `summary()`, un résumé des performances couplées avec des comparaisons par rapport aux périodes antérieures de la série.
...
* `mean_m()`qui renvoie un nouveau jeu des données créé après transformation de la série intiales. 
...
Nous allons illustré le fonctionnement de ces fonctions à l'aide d'un jeu de données contenant les indicateurs de l’activité du service voix mobile d'un operateur de téléphonie mobile anonyme.
...
Dans les secteurs d’activité auxquels nous travaillons, on utilise plus les variations suivantes :


* La variation *DoD* en date du *2023-08-11* : elle consiste à calculer la variation du revenu en cette date par rapport à la date du *2023-08-10*, c-est-à-dire:
$$DoD = \frac{dday - dday_1}{dday_1}$$

* La variation *SPLM* en date du *2023-08-11* : elle consite à calculer la variation *MTD* au *2023-08-11* par rapport au *MTD* en date du *2023-07-11* (on note souvent par $MTD_1$) :
$$SLPM = \frac{MTD - MTD_1}{MTD_1}$$

* La variation *YoY* en date du *2023-08-11* : elle consite à calculer la variation *YTD* au *2023-08-11* par rapport au *YTD* en date du *2022-08-11* (on note souvent par $YTD_1$) :
$$YoY = \frac{YTD - YTD_1}{YTD_1}$$

On parle aussi de la variation *WoW*, *MoM*, *SPLY*, etc.
